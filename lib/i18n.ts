...
export const TRANSLATIONS = {
  en: {
    ...
    votes: "Votes",
    voteQuestion: "Legislative vote",
    voteQuestionsLoaded: "vote questions available",
    voteSource: "Official source",
    voted: "voted",
    majority: "Majority",
  ...
  ro: {
    ...
    votes: "Voturi",
    voteQuestion: "Vot legislativ",
    voteQuestionsLoaded: "întrebări despre voturi disponibile",
    voteSource: "Sursa oficială",
    voted: "au votat",
    majority: "Majoritate",
    totalPresent: "prezenți",
    wrong: "Greșit",
